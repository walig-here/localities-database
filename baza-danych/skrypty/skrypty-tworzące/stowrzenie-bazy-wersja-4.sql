...
-- Zrzut struktury wyzwalacz projekt_bd.After_Delete_On_Attractions_Locations
...
-- Zrzut struktury wyzwalacz projekt_bd.After_Delete_On_Figures_Containing_Attractions
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Zrzut struktury wyzwalacz projekt_bd.After_Delete_On_Locations
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
